...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 25 15:39:12 2019
...
def LSP(date, vel, errvel, filename, newfile):

#——————————

    Data=ascii.read((filename),names=('date', 'vel', 'errvel'))
    starname="HD30219"
    
    #——————————
    
    #Mass Upper Limit Periodograms
    ...
    ls = AP_LS(date, vel, errvel)  #Analyze our dates and s-index data using the AstroPy Lomb Scargle module
    ...
    plt.savefig(newfile)                     #Save the figure 
    plt.clf()
    plt.close(fig)